...
- (void)createViews{
    ...
    _likeButton.frame = CGRectMake(5, CGRectGetMaxY(_iconImageView.frame) + 10, (SCREEN_WIDTH-10)/4, 35);
    ...
    _recommendButton.frame = CGRectMake(CGRectGetMaxX(_likeButton.frame), CGRectGetMaxY(_iconImageView.frame) + 10, (SCREEN_WIDTH-10)/4, 35);
    ...
    _followingButton.frame = CGRectMake(CGRectGetMaxX(_recommendButton.frame), CGRectGetMaxY(_iconImageView.frame) + 10, (SCREEN_WIDTH-10)/4, 35);
    ...
    _followedButton.frame = CGRectMake(CGRectGetMaxX(_followingButton.frame), CGRectGetMaxY(_iconImageView.frame) + 10,(SCREEN_WIDTH-10)/4, 35);
